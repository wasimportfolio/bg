...
@section('title', 'Edit Recording - Bathra Groups')
...
<div>
    ...
    <div class="flex flex-col sm:flex-row
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-2">
                Update recording details or change the YouTube video.
            </p>
    ...
    <div class="max-w-3xl">
        ...
        >
            ...
            <form
                method="POST"
                action="{{ route('admin.recordings.update', $recording) }}"
                class="p-6 lg:p-8"
            >
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="w-full px-4 py-3 rounded-xl
                               ...
                               focus:border-slate-400
                               transition resize-y"
                    >{{ old('description', $recording->description) }}</textarea>
                ...
                <div class="mb-8">
                    ...
                    <input
                        ...
                        id="video"
                        name="video"
                        value="{{ old('video', $recording->video) }}"
                        required
                    ...
                    <p class="text-xs text-slate-400 mt-2">
                        Paste the new YouTube video link here.
                    </p>
